...
const jsonLd = {
  ...
  "description": "Fight your traffic ticket with Trial by Declaration in California for free with our form generator.", 
...
export default function TrialByDeclarationPage() {
  ...
  const searchCourts = (term: string) => {
    if (!term) {
      setCourts([]);
      return;
    }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8  ">
            ...
            <div className="text-center">
              ...
              <div className="relative rounded-xl border border-blue-100 bg-white/50 backdrop-blur-sm p-6 shadow-lg">
                ...
                <p className="text-lg sm:text-xl leading-8 text-gray-600">
                  Save time, skip the courtroom, and fight your traffic ticket in writing. Our free Trial by Written Declaration generator creates a court-ready statement instantly.
                </p>
                <p className="mt-4 text-lg sm:text-xl leading-8 text-gray-600">
                  No lawyers, no lines, no hassle—just a simple step-by-step form that could help you reduce or dismiss your ticket.
                </p>
                ...
                <div className="mt-8 flex justify-center gap-4 round">
                  ...
                  <div className="flex items-center space-x-2 text-sm text-gray-500">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-500" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M6.672 1.911a1 1 0 10-1.932.518l.259.966a1 1 0 001.932-.518l-.26-.966zM2.429 4.74a1 1 0 10-.517 1.932l.966.259a1 1 0 00.517-1.932l-.966-.26zm8.814-.569a1 1 0 00-1.415-1.414l-.707.707a1 1 0 101.415 1.415l.707-.708zm-7.071 7.072l.707-.707A1 1 0 003.465 9.12l-.708.707a1 1 0 001.415 1.415zm3.2-5.171a1 1 0 00-1.3 1.3l4 10a1 1 0 001.823.075l1.38-2.759 3.018 3.02a1 1 0 001.414-1.414l-3.019-3.02 2.76-1.379a1 1 0 00-.076-1.822l-10-4z" clipRule="evenodd" />
                    </svg>
        ...
        <div className="max-w-3xl mx-auto mb-12 text-center">
          ...
          <p className="text-lg text-gray-600">
            A Trial by Written Declaration is an official way to fight a traffic ticket by mail. Instead of appearing in court, you submit a written defense. If successful, you can avoid fines, points on your record, and wasted time in court.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gradient-to-br from-white to-blue-50 p-6 rounded-xl shadow-md border border-blue-100 hover:shadow-lg transition-shadow">
              <div className="flex items-center mb-4">
                ...
                <div className="text-xl font-semibold text-gray-900">1. Fill Out Form</div>
              </div>
              <p className="text-gray-600 ml-[3.25rem]">Enter your traffic ticket details and defense statement in our simple form.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-white to-blue-50 p-6 rounded-xl shadow-md border border-blue-100 hover:shadow-lg transition-shadow">
              <div className="flex items-center mb-4">
                ...
                <div className="text-xl font-semibold text-gray-900">2. Download</div>
              </div>
              <p className="text-gray-600 ml-[3.25rem]">Instantly receive your personalized declaration document.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-white to-blue-50 p-6 rounded-xl shadow-md border border-blue-100 hover:shadow-lg transition-shadow">
              <div className="flex items-center mb-4">
                ...
                <div className="text-xl font-semibold text-gray-900">3. Add Payment</div>
              </div>
              <p className="text-gray-600 ml-[3.25rem]">Include a check for your ticket amount with your declaration.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-white to-blue-50 p-6 rounded-xl shadow-md border border-blue-100 hover:shadow-lg transition-shadow">
              <div className="flex items-center mb-4">
                ...
                <div className="text-xl font-semibold text-gray-900">4. Mail It In</div>
              </div>
              <p className="text-gray-600 ml-[3.25rem]">Submit your signed documents to the court before the deadline.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-white to-green-50 p-6 rounded-xl shadow-md border border-green-100 hover:shadow-lg transition-shadow">
              <div className="flex items-center mb-4">
                ...
                <div className="text-xl font-semibold text-gray-900">If You Win</div>
              </div>
              <p className="text-gray-600 ml-[3.25rem]">Your ticket is dismissed and the court returns your payment.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-white to-orange-50 p-6 rounded-xl shadow-md border border-orange-100 hover:shadow-lg transition-shadow">
              <div className="flex items-center mb-4">
                ...
                <div className="text-xl font-semibold text-gray-900">If You Lose</div>
              </div>
              <p className="text-gray-600 ml-[3.25rem]">You can file a Trial De Novo to contest the ticket again in court.</p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600">Totally free. No hidden costs.</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <div className="rounded-full bg-blue-100 p-2">
              ...
              <div>
                <h3 className="font-semibold text-lg mb-1">Convenient & Fast</h3>
                <p className="text-gray-600">Complete it in minutes from any device.</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <div className="rounded-full bg-blue-100 p-2">
              ...
              <div>
                <h3 className="font-semibold text-lg mb-1">Professional Format</h3>
                <p className="text-gray-600">Automatically tailored to meet court requirements.</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <div className="rounded-full bg-blue-100 p-2">
              ...
              <div>
                <h3 className="font-semibold text-lg mb-1">No Legal Jargon</h3>
                <p className="text-gray-600">Plain language prompts make it easy.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto mb-12 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Fill out the form below to generate your FREE Trial by Declaration now.
          </p>
        </div>
            ...
            <Card className="mt-2 max-w-5xl mx-auto">
              <CardContent className="p-2">
                <div className="space-y-2">
                  {courts.map((court) => {
                    const handlesTraffic = court.matters_served.includes('All') || court.matters_served.includes('Traffic');
                    return (
                      <button
                        key={court.id}
                        ...
                        className={cn(
                          ...
                          !handlesTraffic && "border-l-4 border-yellow-400 bg-yellow-50"
                        )}
                      >
                        <div className="font-medium">{court.courthouse_name}</div>
                        ...
                        {!handlesTraffic && (
                          <div className="mt-2 text-sm text-yellow-600 bg-yellow-50 p-2 rounded">
                            ⚠️ This location may not handle traffic violations. Please verify by calling the courthouse or checking their website.
                          </div>
                        )}
                      </button>
                    );
        ...
        >
          <div className="grid grid-cols-4 border-b border-gray-300">
            <div className="col-span-3 p-3 space-y-0.5 border-r border-gray-300">
              <div className="flex items-start space-x-2">
                <Label htmlFor="NameOfCourt" className="min-w-[140px] text-sm font-bold pt-2">
                  NAME OF COURT:
                </Label>
                <Input
                  id="NameOfCourt"
              ...
              <div className="flex items-start space-x-2">
                <Label htmlFor="CourtStreetAddress" className="min-w-[140px] text-sm font-bold pt-2">
                  STREET ADDRESS:
                </Label>
                <Input
              ...
              <div className="flex items-start space-x-2">
                <Label htmlFor="CourtMailingAddress" className="min-w-[140px] text-sm font-bold pt-2">
                  MAILING ADDRESS:
                </Label>
                <Input
              ...
              <div className="flex items-start space-x-2">
                <Label htmlFor="CourtCityAndZipcode" className="min-w-[140px] text-sm font-bold pt-2">
                  CITY AND ZIP CODE:
                </Label>
                <Input
              ...
              <div className="flex items-start space-x-2">
                <Label htmlFor="CourtBranchName" className="min-w-[140px] text-sm font-bold pt-2">
                  BRANCH NAME:
                </Label>
                <Input
                  id="CourtBranchName"
          ...
          {/* Statement of Facts */}
          <div className="p-4 border-b border-gray-300">
            <Label htmlFor="StatementOfFacts" className="block font-bold mb-2">
              STATEMENT OF FACTS
            </Label>
            <textarea
              id="StatementOfFacts"
